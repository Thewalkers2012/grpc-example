...
func (c *laptopServiceClient) UploadImage(ctx context.Context, opts ...grpc.CallOption) (LaptopService_UploadImageClient, error) {
	stream, err := c.cc.NewStream(ctx, &LaptopService_ServiceDesc.Streams[1], "/pb.LaptopService/UploadImage", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *laptopServiceUploadImageClient) Send(m *UploadmageRequest) error {
...
func (c *laptopServiceClient) RateLaptop(ctx context.Context, opts ...grpc.CallOption) (LaptopService_RateLaptopClient, error) {
	stream, err := c.cc.NewStream(ctx, &LaptopService_ServiceDesc.Streams[2], "/pb.LaptopService/RateLaptop", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *laptopServiceUploadImageServer) Recv() (*UploadmageRequest, error) {
	m := new(UploadmageRequest)
